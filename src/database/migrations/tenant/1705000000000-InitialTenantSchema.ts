export class InitialTenantSchema1705000000000 {
  public async up(queryRunner: any): Promise<void> {
    ...
    await queryRunner.query(`
      ...
      CREATE UNIQUE INDEX IF NOT EXISTS "IDX_CONTACT_TENANT_EXT" ON "contacts" ("tenant_id", "external_id");
      ...
      CREATE UNIQUE INDEX IF NOT EXISTS "IDX_INVOICE_TENANT_EXT" ON "invoices" ("tenant_id", "external_id");
      ...
      CREATE UNIQUE INDEX IF NOT EXISTS "IDX_PRODUCT_TENANT_EXT" ON "products" ("tenant_id", "external_id");
      ...
      CREATE UNIQUE INDEX IF NOT EXISTS "IDX_ORDER_TENANT_EXT" ON "orders" ("tenant_id", "external_id");
      ...
      CREATE INDEX IF NOT EXISTS "IDX_QUARANTINE_TENANT_STATUS" ON "quarantine_records"
