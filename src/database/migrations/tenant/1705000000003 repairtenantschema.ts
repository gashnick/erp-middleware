// src/database/migrations/tenant/1705000000003-RepairTenantSchema.ts
//
// This migration exists because the original InitialTenantSchema migration
// had a search_path bug that caused all tables to be created in public
// instead of the tenant schema. This migration creates any missing tables
// inside the correct tenant schema using IF NOT EXISTS guards so it is
// fully idempotent and safe to run on both broken and healthy schemas.

export class RepairTenantSchema1705000000003 {
  public async up(queryRunner: any): Promise<void> {
    await queryRunner.query(`
      ...
      CREATE TABLE IF NOT EXISTS "insight_feedback" (
        ...
        CONSTRAINT "UQ_insight_feedback" UNIQUE ("user_id", "insight_id")
      );
